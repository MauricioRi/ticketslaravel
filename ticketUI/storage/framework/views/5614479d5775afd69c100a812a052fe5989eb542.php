...
<div class="wrapper">
    ...
    <div class="main-panel">
        <?php if(isset($geo)): ?>
        <?php endif; ?>
        <button onclick="loadGeocercas()">Ver geocerca <?php echo e($geo[0]->nombre); ?></button>
        <div id="map">
...
<script>
    ...
    function loadGeocercas() {
        ...
        poligonos = new Map();
        id = <?php echo json_encode($geo->toArray()); ?>[0].id
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\GitHub\ticketslaravel\ticketUI\resources\views/edit_geofence.blade.php ENDPATH**/ ?>