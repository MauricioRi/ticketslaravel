...
@section('content')
                    ...
                    @if ($user->name != '')
                        <form action="{{ URL::route('usuarios.update', $user->id) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control" id="formUsuarioNombre"
                                    aria-describedby="nombreHelp" value="{{ $user->name }}" name="nombre">
                                <div id="nombreHelp" class="form-text"></div>
                            </div>

                            <div class="mb-3">
                                <label for="formUsuarioContraseña" class="form-label">Contraseña</label>
                                <input type="password" class="form-control" id="formUsuarioContraseña"
                                    aria-describedby="contraseñaHelp" name="contra">
                                <div id="contraseñaHelp" class="form-text"></div>
                            </div>

                            <div class="mb-3">
                                <label for="formUsuarioCorreo" class="form-label">Correo</label>
                                <input required type="email" class="form-control" id="formUsuarioCorreo"
                                    aria-describedby="correoHelp" value="{{ $user->email }}" name="correo">
                    ...
                    @else
                        <form action="{{ URL::route('usuarios.create') }}" method="post">
                            ...
                            <div class="mb-3">
                                <label for="formUsuarioNombre" class="form-label">Nombre</label>
                                <input required type="text" class="form-control" id="formUsuarioNombre"
                                    aria-describedby="nombreHelp"  name="nombre">
                                <div id="nombreHelp" class="form-text"></div>
                            </div>

                            <div class="mb-3">
                                <label for="formUsuarioContraseña" class="form-label">Contraseña</label>
                                <input required type="password" class="form-control" id="formUsuarioContraseña"
                                    aria-describedby="contraseñaHelp" name="contra">
                                <div id="contraseñaHelp" class="form-text"></div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="formUsuarioCorreo" class="form-label">Correo</label>
                                <input required type="email" class="form-control" id="formUsuarioCorreo"
                                    aria-describedby="correoHelp"  name="correo">
                                <div id="correoHelp" class="form-text"></div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#empresa').prop('value', user.empresa)
